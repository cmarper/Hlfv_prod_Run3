...
# with command line options: --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --conditions 130X_mcRun3_2023_realistic_postBPix_v6 --step NANO --scenario pp --era Run3_2023 --python_filename Run3Summer23BPixNanoAODv12-VBFHiggsToTauMu_cfg.py --fileout file:Run3Summer23BPixNanoAODv12-VBFHiggsToTauMu.root --filein file:Run3Summer23BPixMiniAODv4-VBFHiggsToTauMu.root --number 1000000 --number_out 1000000 --no_exec --mc
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:Run3Summer23BPixMiniAODv4-VBFHiggsToTauMu.root'),
...
process.NANOEDMAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Run3Summer23BPixNanoAODv12-VBFHiggsToTauMu.root'),
