...
# with command line options: Configuration/GenProduction/python/Run3Summer22EELHEGS-VBFHiggsToTauE-fragment.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=12345 --step LHE,GEN,SIM --geometry DB:Extended --era Run3 --python_filename Run3Summer22EEwmLHEGS-VBFHiggsToTauE_cfg.py --fileout file:Run3Summer22EEwmLHEGS-VBFHiggsToTauE.root --number 1000000 --number_out 1000000 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Run3Summer22EELHEGS-VBFHiggsToTauE-fragment.py nevts:1000000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Run3Summer22EEwmLHEGS-VBFHiggsToTauE.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Run3Summer22EEwmLHEGS-VBFHiggsToTauE_inLHE.root'),
