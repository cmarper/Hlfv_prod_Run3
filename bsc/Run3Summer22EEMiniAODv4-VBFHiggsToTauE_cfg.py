...
# with command line options: --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --conditions 130X_mcRun3_2022_realistic_postEE_v6 --step PAT --geometry DB:Extended --era Run3,run3_miniAOD_12X --python_filename Run3Summer22EEMiniAODv4-VBFHiggsToTauE_cfg.py --fileout file:Run3Summer22EEMiniAODv4-VBFHiggsToTauE.root --filein file:Run3Summer22EEDR-VBFHiggsToTauE.root --number 1000000 --number_out 1000000 --no_exec --mc
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:Run3Summer22EEDR-VBFHiggsToTauE.root'),
