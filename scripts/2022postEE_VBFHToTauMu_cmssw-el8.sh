...
curl -L -o configs_2022postEE_VBFHToTauMu.zip https://cernbox.cern.ch/s/rtFBvDGjCGzmnpk/download
unzip configs_2022postEE_VBFHToTauMu.zip -d .
mv 2022postEE_VBFHToTauMu/ configs/
echo "Done."
...
curl -s -k --retry 3 --create-dirs -o Configuration/GenProduction/python/Run3Summer22EELHEGS-VBFHiggsToTauMu-fragment.py $fragmentfile
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEwmLHEGS-VBFHiggsToTauMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEDR-VBFHiggsToTauMu_1_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEDR-VBFHiggsToTauMu_2_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEMiniAODv4-VBFHiggsToTauMu_cfg.py 
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EENanoAODv12-VBFHiggsToTauMu_cfg.py
echo "Done."
