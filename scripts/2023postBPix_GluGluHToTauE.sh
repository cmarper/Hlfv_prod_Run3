...
# Settings
#nevents=1000000
fragmentfile=https://cernbox.cern.ch/s/EYLxgZQYQAiiEHD/download
...
curl -L -o configs_2023postBPix_GluGluHToTauE.zip https://cernbox.cern.ch/s/TUHNQvyITJL53rU/download
unzip configs_2023postBPix_GluGluHToTauE.zip -d .
mv 2023postBPix_GluGluHToTauE/ configs/
echo "Done."
...
curl -s -k --retry 3 --create-dirs -o Configuration/GenProduction/python/Run3Summer23BPixLHEGS-ggHiggsToTauE-fragment.py $fragmentfile
echo "Done."
...
#cmsRun ../../configs/Run3Summer23BPixwmLHEGS-ggHiggsToTauE_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer23BPixDRPremix-ggHiggsToTauE_1_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer23BPixDRPremix-ggHiggsToTauE_2_cfg.py
echo "Done."
