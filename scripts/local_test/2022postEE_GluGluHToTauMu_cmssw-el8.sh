...
cmsRun Run3Summer22EEwmLHEGS-ggHiggsToTauMu_cfg.py
echo "Done."
...
cmsRun Run3Summer22EEDR-ggHiggsToTauMu_1_cfg.py
echo "Done."
...
cmsRun Run3Summer22EEDR-ggHiggsToTauMu_2_cfg.py
echo "Done."
...
cmsRun Run3Summer22EEMiniAODv4-ggHiggsToTauMu_cfg.py
echo "Done."
...
cmsRun Run3Summer22EENanoAODv12-ggHiggsToTauMu_cfg.py
echo "Done."
