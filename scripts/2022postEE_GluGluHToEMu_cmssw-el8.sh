...
curl -L -o configs_2022postEE_GluGluHToEMu.zip https://cernbox.cern.ch/s/2N7s5Gn8IO4uHDI/download
unzip configs_2022postEE_GluGluHToEMu.zip -d .
mv 2022postEE_GluGluHToEMu/ configs/
echo "Done."
...
curl -s -k --retry 3 --create-dirs -o Configuration/GenProduction/python/Run3Summer22EELHEGS-ggHiggsToEMu-fragment.py $fragmentfile
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEwmLHEGS-ggHiggsToEMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEDR-ggHiggsToEMu_1_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEDR-ggHiggsToEMu_2_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEMiniAODv4-ggHiggsToEMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EENanoAODv12-ggHiggsToEMu_cfg.py
echo "Done."
