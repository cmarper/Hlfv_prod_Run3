...
cp ../../Hlfv_prod_Run3/fragments/fragment-ggHiggsEMu.py Configuration/GenProduction/python/Run3Summer22EELHEGS-ggHiggsToEMu-fragment.py
...
#cmsRun ../../configs/Hlfv_prod_Run3/Run3Summer22EEwmLHEGS-ggHiggsToEMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Hlfv_prod_Run3/Run3Summer22EEDR-ggHiggsToEMu_1_cfg.py
echo "Done."
...
#cmsRun ../../configs/Hlfv_prod_Run3/Run3Summer22EEDR-ggHiggsToEMu_2_cfg.py
echo "Done."
...
#cmsRun ../../configs/Hlfv_prod_Run3/Run3Summer22EEMiniAODv4-ggHiggsToEMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Hlfv_prod_Run3/Run3Summer22EENanoAODv12-ggHiggsToEMu_cfg.py
echo "Done."
