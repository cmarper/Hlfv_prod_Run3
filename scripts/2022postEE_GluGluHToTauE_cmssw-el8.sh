...
curl -L -o configs_2022postEE_GluGluHToTauE.zip https://cernbox.cern.ch/s/sjvE11swtquviaU/download
unzip configs_2022postEE_GluGluHToTauE.zip -d .
mv 2022postEE_GluGluHToTauE/ configs/
echo "Done."
...
curl -s -k --retry 3 --create-dirs -o Configuration/GenProduction/python/Run3Summer22EELHEGS-ggHiggsToTauE-fragment.py $fragmentfile
echo "Done."
