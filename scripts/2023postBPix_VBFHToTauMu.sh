...
# Settings
#nevents=1000000
fragmentfile=https://cernbox.cern.ch/s/z5fF5aQwN2qegHY/download
...
curl -L -o configs_2023postBPix_VBFHToTauMu.zip https://cernbox.cern.ch/s/koPnlp7YpmNH9um/download
unzip configs_2023postBPix_VBFHToTauMu.zip -d .
mv 2023postBPix_VBFHToTauMu/ configs/
echo "Done."
...
curl -s -k --retry 3 --create-dirs -o Configuration/GenProduction/python/Run3Summer23BPixLHEGS-VBFHiggsToTauMu-fragment.py $fragmentfile
echo "Done."
...
#cmsRun ../../configs/Run3Summer23BPixwmLHEGS-VBFHiggsToTauMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer23BPixDRPremix-VBFHiggsToTauMu_1_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer23BPixDRPremix-VBFHiggsToTauMu_2_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer23BPixMiniAODv4-VBFHiggsToTauMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer23BPixNanoAODv12-VBFHiggsToTauMu_cfg.py
echo "Done."
