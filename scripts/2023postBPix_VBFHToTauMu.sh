...
cp ../../Hlfv_prod_Run3/fragments/fragment-VBFHiggsTauMu.py Configuration/GenProduction/python/Run3Summer23BPixLHEGS-VBFHiggsToTauMu-fragment.py
...
#cmsRun ../../Hlfv_prod_Run3/Hlfv_prod_Run3/configs/Hlfv_prod_Run3/Run3Summer23BPixwmLHEGS-VBFHiggsToTauMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Hlfv_prod_Run3/Run3Summer23BPixDRPremix-VBFHiggsToTauMu_1_cfg.py
echo "Done."
...
#cmsRun ../../configs/Hlfv_prod_Run3/Run3Summer23BPixDRPremix-VBFHiggsToTauMu_2_cfg.py
echo "Done."
...
#cmsRun ../../configs/Hlfv_prod_Run3/Run3Summer23BPixMiniAODv4-VBFHiggsToTauMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Hlfv_prod_Run3/Run3Summer23BPixNanoAODv12-VBFHiggsToTauMu_cfg.py
echo "Done."
