...
curl -L -o configs_2022postEE_GluGluHToTauMu.zip https://cernbox.cern.ch/s/akpZlSfnUu9q0vx/download
unzip configs_2022postEE_GluGluHToTauMu.zip -d .
mv 2022postEE_GluGluHToTauMu/ configs/
echo "Done."
...
curl -s -k --retry 3 --create-dirs -o Configuration/GenProduction/python/Run3Summer22EELHEGS-ggHiggsToTauMu-fragment.py $fragmentfile
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEwmLHEGS-ggHiggsToTauMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEDR-ggHiggsToTauMu_1_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEDR-ggHiggsToTauMu_2_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EEMiniAODv4-ggHiggsToTauMu_cfg.py
echo "Done."
...
#cmsRun ../../configs/Run3Summer22EENanoAODv12-ggHiggsToTauMu_cfg.py
echo "Done."
